...
def parse_command():
    ...
    parser.add_argument("--finetune", type=str, help="path to finetune checkpoint")
...
def main():
    ...
    if args.finetune is not None:
        if os.path.exists(args.finetune):
            ...
            if is_main_process:
                raise FileNotFoundError(f"Model checkpoint {args.finetune} not found")
